...
public final class SensorServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "SensorService.SensorService";
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.SensorService.AddSensorRequest,
      grpc.SensorService.AddSensorResponse> getAddSensorMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "AddSensor",
      requestType = grpc.SensorService.AddSensorRequest.class,
      responseType = grpc.SensorService.AddSensorResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpc.SensorService.AddSensorRequest,
      grpc.SensorService.AddSensorResponse> getAddSensorMethod() {
    io.grpc.MethodDescriptor<grpc.SensorService.AddSensorRequest, grpc.SensorService.AddSensorResponse> getAddSensorMethod;
    if ((getAddSensorMethod = SensorServiceGrpc.getAddSensorMethod) == null) {
      synchronized (SensorServiceGrpc.class) {
        if ((getAddSensorMethod = SensorServiceGrpc.getAddSensorMethod) == null) {
          SensorServiceGrpc.getAddSensorMethod = getAddSensorMethod =
              io.grpc.MethodDescriptor.<grpc.SensorService.AddSensorRequest, grpc.SensorService.AddSensorResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "AddSensor"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.SensorService.AddSensorRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.SensorService.AddSensorResponse.getDefaultInstance()))
              .setSchemaDescriptor(new SensorServiceMethodDescriptorSupplier("AddSensor"))
              .build();
        }
      }
    }
    return getAddSensorMethod;
  }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void addSensor(grpc.SensorService.AddSensorRequest request,
        io.grpc.stub.StreamObserver<grpc.SensorService.AddSensorResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getAddSensorMethod(), responseObserver);
    }
  }
  ...
  public static final class SensorServiceStub
    ...
    /**
     */
    public void addSensor(grpc.SensorService.AddSensorRequest request,
        io.grpc.stub.StreamObserver<grpc.SensorService.AddSensorResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getAddSensorMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class SensorServiceBlockingStub
    ...
    /**
     */
    public grpc.SensorService.AddSensorResponse addSensor(grpc.SensorService.AddSensorRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getAddSensorMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class SensorServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.SensorService.AddSensorResponse> addSensor(
        grpc.SensorService.AddSensorRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getAddSensorMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_STREAM_SENSOR_DATA = 0;
  private static final int METHODID_ADD_SENSOR = 1;
      ...
      switch (methodId) {
        case METHODID_STREAM_SENSOR_DATA:
          serviceImpl.streamSensorData((grpc.SensorService.SensorRequest) request,
              (io.grpc.stub.StreamObserver<grpc.SensorService.SensorResponse>) responseObserver);
          break;
        case METHODID_ADD_SENSOR:
          serviceImpl.addSensor((grpc.SensorService.AddSensorRequest) request,
              (io.grpc.stub.StreamObserver<grpc.SensorService.AddSensorResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              grpc.SensorService.AddSensorRequest,
              grpc.SensorService.AddSensorResponse>(
                service, METHODID_ADD_SENSOR)))
        .build();
  }
