...
public final class SensorServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.SensorService.SensorRequest,
      grpc.SensorService.SensorResponse> getAddSensorMethod;
  ...
  public static io.grpc.MethodDescriptor<grpc.SensorService.SensorRequest,
      grpc.SensorService.SensorResponse> getAddSensorMethod() {
    io.grpc.MethodDescriptor<grpc.SensorService.SensorRequest, grpc.SensorService.SensorResponse> getAddSensorMethod;
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void addSensor(grpc.SensorService.SensorRequest request,
  ...
  public static final class SensorServiceStub
    ...
    /**
     */
    public void addSensor(grpc.SensorService.SensorRequest request,
        io.grpc.stub.StreamObserver<grpc.SensorService.SensorResponse> responseObserver) {
  ...
  public static final class SensorServiceBlockingStub
    ...
    /**
     */
    public grpc.SensorService.SensorResponse addSensor(grpc.SensorService.SensorRequest request) {
  ...
  public static final class SensorServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.SensorService.SensorResponse> addSensor(
  ...
  private static final int METHODID_ADD_SENSOR = 0;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ADD_SENSOR:
          serviceImpl.addSensor((grpc.SensorService.SensorRequest) request,
              (io.grpc.stub.StreamObserver<grpc.SensorService.SensorResponse>) responseObserver);
          break;
